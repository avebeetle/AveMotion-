...
60/60, 38/40 (same baseline Samsung failures), 54/54 and29/29. The safe partial
scope is finished; unchecked optimization acceptance items remain deferred,
not work silently completed by this run.
